...
public class DataMigrationCore implements IDataMigration{
	...
	protected String getMysqlCreateSentence(List<TableColumnDesc> fieldNames,List<String> primaryKeys,String tableName,boolean createIfNotExist) throws UnsupportJdbcTypeMapper {
